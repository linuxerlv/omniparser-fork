...
class ComputerTool(BaseAnthropicTool):
    ...
    async def __call__(
        ...
        **kwargs,
        ...
        print(
            f"action: {action}, text: {text}, coordinate: {coordinate}, is_scaling: {self.is_scaling}"
        )
    ...
    def send_to_vm(self, action: str):
        ...
        try:
            ...
            raise ToolError(f"An error occurred while trying to execute the command: {e!s}")

    async def screenshot(self):
        if not hasattr(self, "target_dimension"):
            # Capture once at native resolution to determine padding,
            # then re-capture at the target dimension below.
            screenshot, _path = get_screenshot()
    ...
    def get_screen_size(self):
        ...
        try:
            ...
            raise ToolError(f"An error occurred while trying to get screen size: {e!s}")
